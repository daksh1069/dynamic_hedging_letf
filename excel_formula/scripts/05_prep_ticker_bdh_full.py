"""
Build the FULL Bloomberg BDH prep workbook for one underlying's filtered call
options' closing prices (PX_LAST) and volume (PX_VOLUME), 2020-01-01 ->
2026-06-10.
...
if len(sys.argv) < 2:
    sys.exit("Usage: python excel_formula/scripts/05_prep_ticker_bdh_full.py TICKER")
TICKER = sys.argv[1]
...
INSTRUCTIONS = [
    ...
    "excel_formula/scripts/05_prep_ticker_bdh_full.py and regenerate -- this is",
